...
$subscriber_count = mysqli_num_rows($select_all_subscribers);   
    ...
    $element_text = ['All Posts','Active Posts', 'Draft Posts', 'Categories', 'Pending Comments', 'Users','Subscribers', 'Comments'];   
                        
    
    $element_count = [$post_counts,$post_published_counts,$post_draft_counts, $category_counts,$unapproved_comment_counts,$user_counts,$subscriber_count,$comment_counts];  
